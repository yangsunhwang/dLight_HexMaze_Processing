...
def align_pos_to_visits(Fs, visits, datepath, phot_dlc='n',
    ...
    if phot_dlc == 'y':
        ...
        # dlc_pos_file = 'Behav_Vid0DLC_resnet50_Triangle_Maze_Phot_RobustJun8shuffle1_250000.h5'
        # dlc_pos = pd.read_hdf(datepath + dlc_pos_file).DLC_resnet50_Triangle_Maze_Phot_RobustJun8shuffle1_250000
        dlc_pos_file = 'Behav_Vid0DLC_resnet50_Triangle_Maze_PhotFeb12shuffle1_800000.h5'
        dlc_pos = pd.read_hdf(datepath + dlc_pos_file).DLC_resnet50_Triangle_Maze_PhotFeb12shuffle1_800000
    else:
